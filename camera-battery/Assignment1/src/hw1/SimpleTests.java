 ...
 * CameraBattery class. Warning: these tests do not cover all of the
...
public class SimpleTests {
	public static void main(String args[]) {
		...
		double amountDrained = cb.drain(100.0);
		System.out.println();
		System.out.println("Test 4:");
		System.out.println("Battery drained by " + amountDrained + " expected 100.0");
		...
		amountDrained = cb.drain(1000.0);
		System.out.println();
		System.out.println("Test 5:");
		System.out.println("Battery drained by " + amountDrained + " expected 900.0");
		...
		double amountChargedCamera = cb.cameraCharge(50.0);
		System.out.println();
		System.out.println("Test 6:");
		System.out.println("Battery charged by " + amountChargedCamera + " expected 100.0");
		...
		amountDrained = cb.drain(50.0);
		System.out.println();
		System.out.println("Test 7:");
		System.out.println("Battery drained by " + amountDrained + " expected 0.0");
		System.out.println("Battery charge is " + cb.getBatteryCharge() + " expected 100.0");
		System.out.println("Camera charge is " + cb.getCameraCharge() + " expected 0.0");
		System.out.println("Total drain is " + cb.getTotalDrain() + " expected 1000.0");
		...
		System.out.println("External charger setting is " + cb.getChargerSetting() + " exptected 2");
